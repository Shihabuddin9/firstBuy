...
const Cart = () => {
    const { allFoods, cartItems, displayFood } = useContext(AuthContext)
    return (
        <div>
                                ...
                                allFoods.map(food => {
                                    if (cartItems[food.id] > 0) {
                                        return (
                                            ...
                                            <div key={food.id} className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                                                ...
                                                <div className="flex justify-center items-center w-1/5">
                                                    ...
                                                    <IoIosAdd className=" text-gray-600 text-2xl" />
                                                </div>
